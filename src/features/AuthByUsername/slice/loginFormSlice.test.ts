...
describe("loginFormSlice", () => {
	test("test set username", () => {
		...
		expect(
			loginFormReducer(state as LoginFormSchema, loginFormActions.setUsername("123123")),
	...
	test("test set password", () => {
		...
		expect(
			loginFormReducer(state as LoginFormSchema, loginFormActions.setPassword("123123")),
