...
export const ArticlePreview: FC<ArticlePreviewProps> = ({ className, isTile, data }) => {
		...
		return (
			<Shell className={classNames(cls.ArticlePreview, {}, [className, cls.ArticlePreview_tile])}>
				...
				<div className={cls.ArticlePreview__container}>
					<h2 className={cls.ArticlePreview__title}>Как разработать Telegram-бота для генерации сложных паролей</h2>
